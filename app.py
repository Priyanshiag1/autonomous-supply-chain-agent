"""
StockSentinel — Autonomous Demand-Sensing & Multi-Agent Inventory Rebalancing Digital Twin
-------------------------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
st.set_page_config(
    page_title="StockSentinel • Autonomous Supply Chain Agent",
    page_icon="⚡",
    layout="wide",
...
# -----------------------------------------------------------------------------
st.sidebar.markdown("<div style='font-size:1.2rem; font-weight:800; color:#38BDF8; letter-spacing:-0.02em;'>⚡ StockSentinel</div>", unsafe_allow_html=True)
...
# -----------------------------------------------------------------------------
st.markdown("<div class='system-title'>⚡ StockSentinel • Autonomous Demand-Sensing & Inventory Rebalancing</div>", unsafe_allow_html=True)
